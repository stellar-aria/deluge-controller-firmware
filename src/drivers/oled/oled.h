...
// Returns true if the SPI bus is busy or an OLED (destinationId==0) transfer is
// already waiting in the queue.  Use this to avoid redundant enqueues when the
// caller knows the source buffer (oledMainImage) will be picked up by the in-flight
// transfer.
