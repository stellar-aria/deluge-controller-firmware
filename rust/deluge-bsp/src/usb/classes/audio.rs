...
impl AudioClass {
    ...
    pub fn new<'d, D: Driver<'d>>(
        ...
        let mut ac_alt = ac_ib.alt_setting(
            USB_CLASS_AUDIO, USB_SUBCLASS_AUDIO_CONTROL, USB_PROTOCOL_IP_02_00, None,
        );
        ...
        ac_alt.descriptor(CS_INTERFACE, &[
        ...
        ac_alt.descriptor(CS_INTERFACE, &[
            ...
            CLOCK_SOURCE_ID, 0x02, // bNrChannels = 2
        ...
        let _ = as_ib.alt_setting(
            USB_CLASS_AUDIO, USB_SUBCLASS_AUDIO_STREAMING, USB_PROTOCOL_IP_02_00, None,
        );
        ...
        // CS AS General
        as_alt1.descriptor(CS_INTERFACE, &[
            AS_GENERAL, INPUT_TERM_ID, 0x00, 0x01,
            0x01, 0x00, 0x00, 0x00, // bmFormats: PCM
            0x02, 0x03, 0x00, 0x00, 0x00, // bNrChannels + bmChannelConfig
            0x00,
        ]);
    ...
    pub fn is_streaming(&self) -> bool { self.streaming_active }
}
